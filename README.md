...
|Jayam    | Use SQS in real application                  | https://go.aws/3TkTzpY | Intermediate | 2-3 hours                 | AWS SQS         | Additionally, you need to get Sandbox keys, and use boto3 to consume SQS queue messages |
